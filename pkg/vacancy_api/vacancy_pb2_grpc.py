...
def add_VacancyServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("vacancy.Vacancy", rpc_method_handlers)
