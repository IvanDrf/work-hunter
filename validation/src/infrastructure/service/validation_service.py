...
class ValidationService:
    def __init__(self, metro_repo: IMetroRepo, city_repo: ICityRepo, repo_timeout: float) -> None:
        ...
        self.logger = logging.getLogger("ValidationService")
    ...
    async def is_metro_valid(self, city: str, metro: str) -> bool:
        try:
            ...
            self.logger.critical(f"request to database is too long, {city=}, {metro=}, details={e}")
    ...
    async def is_city_valid(self, city: str) -> bool:
        try:
            ...
            self.logger.critical(f"request to database is too long, {city=}, details={e}")
